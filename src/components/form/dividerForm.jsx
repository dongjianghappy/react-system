...
<div className="module-wrap">
    <div className="module-content basic-info">
      ...
      <span className="name">{props.title}</span>
        ...
        <span data-coding="" className="update-info editbtn" onClick={(e)=>handle(e)}>{isEdit ? "编辑" : "保存"}</span>
            </div>
        <ul className="info">
            {
                isEdit ?
               props.dataSource && props.dataSource.map((item, index) => (
                    ...
                    <div style={{display: 'flex'}}>
                        ...
                        <div className="align_right" style={{width: "50px"}}>
                            {
                                item.isdelete === '0' ? 
                                <R_button.link click={handleClick} id={item.id} title="删除" dispatch="popup" node="dialog" fn="getDelete" />
                                : "" 
                            }
