  ...
  return (
    <>
      ...
      <Form.Item label="焦点位置">
        <Form.Item name="focus_right" label="焦点位置"><Input style={{width: 100}} />(right)</Form.Item>
        <Form.Item name="focus_bottom" label="焦点位置"><Input style={{width: 100}} />(bottom)</Form.Item>
      </Form.Item>
