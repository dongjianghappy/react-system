...
import { Form, Input, Radio, Row, Col, Select } from "antd";
      ...
      <Form.Item label="数据类型" name="dtype">
        <Radio.Group>
          <Row>
            ...
            <Col span={12}>
              <Radio value="VARCHAR" defaultChecked>
                字符串类型(VARCHAR)
              </Radio>
            </Col>
            <Col span={12}>
              <Radio value="int">整数类型(INT)</Radio>
            </Col>
            <Col span={12}>
              <Radio value="float">小数类型(Float)</Radio>
            </Col>
            <Col span={12}>
              <Radio value="datetime">时间类型(DATETIME)</Radio>
            </Col>
          </Row>
        </Radio.Group>
      </Form.Item>
