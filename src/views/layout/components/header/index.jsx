...
import { Layout, Menu, Row, Col, Dropdown, Breadcrumb, message, Space, Input, Badge } from 'antd';
 ...
 const Index = function (props) {
    ...
    return(
        ...
        <div className="header-wrap">
          ...
          <Row>
            <Col>
              <span className="font20" onClick={()=>props.onScreens()} style={{color : "#fff"}}>
                {
                  props.screen 
                  ?
                  <MenuUnfoldOutlined />
          ...
          <div className="header-right">
            <Row>
              ...
              <Col span="6">
              <a onClick={() => route('/admin/service/message', 'service')} className="absolute" style={{top: "6px"}}>
                <Badge count={5}>
              ...
              <Row>
              <Col span="12">风格</Col>
              <Col span="12"><a href="http://127.0.0.1" target="_blank" style={{color: "#fff"}} >首页</a></Col>
