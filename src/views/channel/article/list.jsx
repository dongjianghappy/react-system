    ...
    render(){
        ...
        return(
            <div>
                ...
                <Card
                  title="文档列表"
                  extra={<Link to={{pathname:'/admin/article/detail', state:{coding: art, channel_id: 3}}}>新增文档</Link>}
                >
                  <table width="100%" className="table-striped table-hover artlist col-left-3">
                    ...
                    </tr>
                    {
                      ...
                      <ModalCate {...this.props} id={item.id} artCoding={art} coding={cate}>{item.parent ? item.parent : "未分类"}</ModalCate>
                        ...
                        <td>
                        <Space size="middle">
                          <Link to={{pathname:'/admin/article/detail', state:{id: item.id, coding: art, channel_id: 3}}}>编辑</Link>
